    <?php
      ...
      $term_image = wp_get_attachment_image( $images[$arr_taxonomy[0]->term_taxonomy_id], 'medium' );
      ?>
    <ul> 
   ...
   <?php if($next_page!=0):?>
  <a href="?ajax=1&type=lazyload_media&term=media-coverage&pages=<?php echo $next_page?>" title="ajax" class="next-page hidden"></a>
  <?php endif?>
